...
class StudentView(APIView):
    ...
    def get(request):
        ...
        return Response(StudentGetSerializer(instance=queryset, many=True))


class UserStudentView(APIView):
    @staticmethod
    def post(request):
        serializer = UserStudentPostSerializer(data=request.data)
        if serializer.is_valid():
            serializer.save()
            return Response({'message': 'success'})
        return Response(serializer.errors)
    ...
    def get(request):
        ...
        return Response(UserStudentGetSerializer(instance=queryset, many=True))
